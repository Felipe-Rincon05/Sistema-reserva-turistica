...
public class VDITR {
    public boolean Extraer_validar (String placa){
		...
		try {
			...
			rs = stm.executeQuery("SELECT Placa_trAdmin FROM transporte_admin;");
			while(rs.next()) {
                            if(placa.equals(rs.getString(1))){
                                flag =false;
                            }
			}
    ...
    public boolean validar_id_cond (String id_con){
        ...
        public boolean validar_adm_trans (String id){
            Conexion obc = new Conexion ();
		Connection cn = null;
		Statement stm = null;
		ResultSet rs = null;
    ...
    public boolean validar_id_transAdm (String id){
            Conexion obc = new Conexion ();
		Connection cn = null;
		Statement stm = null;
		ResultSet rs = null;
